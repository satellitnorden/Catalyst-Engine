...
public:
	...
	*/
	void InitializeTerrainEntity(TerrainEntity &terrainEntity, const CPUTexture4 &heightMap, const uint32 terrainPlaneResolution, const TerrainUniformData &terrainUniformData, const Vulkan2DTexture *RESTRICT terrainHeightMapTexture, const Vulkan2DTexture *RESTRICT terrainNormalMapTexture, const Vulkan2DTexture *RESTRICT layer1WeightTexture, const Vulkan2DTexture *RESTRICT layer1AlbedoTexture, const Vulkan2DTexture *RESTRICT layer1NormalMapTexture, const Vulkan2DTexture *RESTRICT layer1RoughnessTexture, const Vulkan2DTexture *RESTRICT layer1MetallicTexture, const Vulkan2DTexture *RESTRICT layer1AmbientOcclusionTexture, const Vulkan2DTexture *RESTRICT layer1DisplacementTexture, const Vulkan2DTexture *RESTRICT layer2WeightTexture = nullptr, const Vulkan2DTexture *RESTRICT layer2AlbedoTexture = nullptr, const Vulkan2DTexture *RESTRICT layer2NormalMapTexture = nullptr, const Vulkan2DTexture *RESTRICT layer2RoughnessTexture = nullptr, const Vulkan2DTexture *RESTRICT layer2MetallicTexture = nullptr, const Vulkan2DTexture *RESTRICT layer2AmbientOcclusionTexture = nullptr, const Vulkan2DTexture *RESTRICT layer2DisplacementTexture = nullptr, const Vulkan2DTexture *RESTRICT layer3WeightTexture = nullptr, const Vulkan2DTexture *RESTRICT layer3AlbedoTexture = nullptr, const Vulkan2DTexture *RESTRICT layer3NormalMapTexture = nullptr, const Vulkan2DTexture *RESTRICT layer3RoughnessTexture = nullptr, const Vulkan2DTexture *RESTRICT layer3MetallicTexture = nullptr, const Vulkan2DTexture *RESTRICT layer3AmbientOcclusionTexture = nullptr, const Vulkan2DTexture *RESTRICT layer3DisplacementTexture = nullptr) const NOEXCEPT;
