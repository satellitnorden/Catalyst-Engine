...
namespace CatalystCoordinateSpacesUtilities
{
	...
	*/
	FORCE_INLINE static NO_DISCARD Vector3<float32> RotatedWorldRightVector(const EulerAngles &rotation) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE static NO_DISCARD Vector3<float32> RotatedWorldForwardVector(const EulerAngles &rotation) NOEXCEPT
	{
