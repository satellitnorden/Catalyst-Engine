...
public:
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float Absolute(const float value) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD static float ArcsineDegrees(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD static float ArcsineRadians(const float number) NOEXCEPT
	{
		return asinf(number);
	}
	...
	*/
	FORCE_INLINE NO_DISCARD static float ArctangentDegrees(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD static float ArctangentRadians(const float number) NOEXCEPT
	{
		return atanf(number);
	}
	...
	*/
	FORCE_INLINE NO_DISCARD static float ArctangentDegrees(const float number1, const float number2) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD static float ArctangentRadians(const float number1, const float number2) NOEXCEPT
	{
	...
	*/
	...
	FORCE_INLINE NO_DISCARD constexpr static Type Ceiling(const float number) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD constexpr static Type Clamp(const Type value, const Type lowerLimit, const Type upperLimit) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float CosineDegrees(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static uint64 Factorial(const uint8 number) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD constexpr static Type Floor(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float Fractional(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float InverseFactorial(const uint8 number) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD constexpr static Type IsEven(const Type number) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD constexpr static Type IsOdd(const Type number) NOEXCEPT
	{
		return Modulo(number, 2) != 0;
	}
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float LinearlyInterpolate(const float valueA, const float valueB, const float alpha) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD constexpr static Type Maximum(const Type firstNumber, const Type secondNumber) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD constexpr static Type Minimum(const Type firstNumber, const Type secondNumber) NOEXCEPT
	{
		return LIKELY(firstNumber < secondNumber) ? firstNumber : secondNumber;
	}
	...
	*/
	...
	FORCE_INLINE NO_DISCARD constexpr static First Modulo(const First input, const Second ceiling) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float PowerOf(const float number, const uint8 exponent) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD static float RandomFloatInRange(const float minimum, const float maximum) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD static Type RandomIntegerInRange(const Type minimum, const Type maximum) NOEXCEPT
	{
		static thread_local std::random_device randomDevice;
		static thread_local std::mt19937 randomEngine{ randomDevice() };
	...
	*/
	FORCE_INLINE NO_DISCARD static bool RandomChance(const float chance) NOEXCEPT
	{
	...
	*/
	template <typename Type>
	FORCE_INLINE NO_DISCARD constexpr static Type Round(const float value) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float ScaleToNormalizedRange(const float value, const float originalRangeMinimum, const float originalRangeMaximum) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float Signum(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float SineDegrees(const float number) NOEXCEPT
	{
	...
	*/
	...
	FORCE_INLINE NO_DISCARD constexpr static float SmoothStep(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float SquareRoot(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD static float TangentDegrees(const float number) NOEXCEPT
	{
	...
	*/
	FORCE_INLINE NO_DISCARD static float TangentRadians(const float number) NOEXCEPT
	{
		return tan(number);
	}
	...
	*/
	FORCE_INLINE NO_DISCARD constexpr static float WrapAround(const float number, const float minimumRange, const float maximumRange) NOEXCEPT
	{
