...
#define INT8_MINIMUM (-127 - 1)
#define INT16_MINIMUM (-32767 - 1)
#define INT24_MINIMUM (-8388607 - 1)
#define INT32_MINIMUM (-2147483647 - 1)
#define INT64_MINIMUM (-9223372036854775807 - 1)
