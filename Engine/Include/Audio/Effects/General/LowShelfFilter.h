...
class LowShelfFilter final : public AudioEffect
{

public:

	//Constants.
	constexpr static float32 DEFAULT_FREQUENCY{ 100.0f };
	...
	*	Default constructor.
	*/
	FORCE_INLINE LowShelfFilter(const float32 frequency = DEFAULT_FREQUENCY, const float32 gain = DEFAULT_GAIN) NOEXCEPT
		:
...
private:
	...
	*/
	FORCE_INLINE void Reset() NOEXCEPT
	{
		...
		{
			biquad.InitializeLowShelf(_Frequency, _Gain, _SampleRate);
		}
	}
