...
CATALYST_SHADER_NAMESPACE_BEGIN(CatalystShaderConstants)
	...
	CATALYST_SHADER_CONSTANT(uint, SCENE_FEATURES_3_RENDER_TARGET_INDEX,								0)
	CATALYST_SHADER_CONSTANT(uint, SCENE_FEATURES_4_RENDER_TARGET_INDEX,								1)
	...
	CATALYST_SHADER_CONSTANT(uint, SCENE_FEATURES_4_HALF_RENDER_TARGET_INDEX,							5)
	CATALYST_SHADER_CONSTANT(uint, SCENE_RENDER_TARGET_INDEX,											6)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_UINT8_RENDER_TARGET_INDEX,							7)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_1_RENDER_TARGET_INDEX,						8)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_2_RENDER_TARGET_INDEX,						9)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_HALF_1_RENDER_TARGET_INDEX,				10)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_HALF_2_RENDER_TARGET_INDEX,				11)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_QUARTER_RENDER_TARGET_INDEX,				12)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_EIGHTH_RENDER_TARGET_INDEX,				13)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_SIXTEENTH_RENDER_TARGET_INDEX,				14)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_THIRTYSECOND_RENDER_TARGET_INDEX,			15)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_SIXTYFOURTH_RENDER_TARGET_INDEX,			16)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_HUNDREDTWENTYEIGHTH_RENDER_TARGET_INDEX,	17)
	CATALYST_SHADER_CONSTANT(uint, NUMBER_OF_RENDER_TARGETS,											18)
