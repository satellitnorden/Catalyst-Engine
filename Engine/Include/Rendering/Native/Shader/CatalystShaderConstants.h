...
CATALYST_SHADER_NAMESPACE_BEGIN(CatalystShaderConstants)
	...
	CATALYST_SHADER_CONSTANT(uint, SCENE_FEATURES_3_HALF_RENDER_TARGET_INDEX,							0)
	CATALYST_SHADER_CONSTANT(uint, SCENE_FEATURES_4_HALF_RENDER_TARGET_INDEX,							1)
	CATALYST_SHADER_CONSTANT(uint, SCENE_RENDER_TARGET_INDEX,											2)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_UINT8_RENDER_TARGET_INDEX,							3)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_1_RENDER_TARGET_INDEX,						4)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_2_RENDER_TARGET_INDEX,						5)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_HALF_1_RENDER_TARGET_INDEX,				6)
	CATALYST_SHADER_CONSTANT(uint, INTERMEDIATE_RGBA_FLOAT32_HALF_2_RENDER_TARGET_INDEX,				7)
