...
public:
	...
	*/
	FORCE_INLINE static void TransformAxisAlignedBoundingBox(const AxisAlignedBoundingBox3D &original_box, const Matrix4x4 &transformation, AxisAlignedBoundingBox3D *const RESTRICT new_box) NOEXCEPT
	{
