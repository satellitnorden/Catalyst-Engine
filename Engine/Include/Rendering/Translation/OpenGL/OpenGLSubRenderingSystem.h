...
class OpenGLSubRenderingSystem final : public SubRenderingSystemInterface
{
...
public:
	...
	*/
	void CreateTextureCube(const uint32 resolution, const DynamicArray<DynamicArray<float32>> &data, TextureCubeHandle *const RESTRICT handle) const NOEXCEPT override;
