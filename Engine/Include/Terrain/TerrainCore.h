...
namespace TerrainConstants
{
	...
	constexpr uint32 TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION{ 64 };
#if defined(CATALYST_FINAL)
	constexpr StaticArray<uint32, TERRAIN_QUAD_TREE_MAX_DEPTH + 1> TERRAIN_NORMAL_TEXTURE_RESOLUTIONS
	{
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 16,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 16,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 8,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 8,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 8,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 4,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 4,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 4,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 2,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION * 2,
		TERRAIN_NORMAL_TEXTURE_BASE_RESOLUTION
	};
#else
	constexpr StaticArray<uint32, TERRAIN_QUAD_TREE_MAX_DEPTH + 1> TERRAIN_NORMAL_TEXTURE_RESOLUTIONS
	{
