...
namespace TerrainGeneralUtilities
{
	...
	*/
	FORCE_INLINE static void GenerateTerrainPlane(const Texture2D<float32> &heightmap, const float32 patch_size, DynamicArray<TerrainVertex> *const RESTRICT vertices, DynamicArray<uint32> *const RESTRICT indices) NOEXCEPT
	{
