...
class GrassVertex final
{

public:

	//The position of this grass vertex.
	Vector3 _Position;

	//The normal of this grass vertex.
	Vector3 _Normal;

	//The tangent of this grass vertex.
	Vector3 _Tangent;

	//The texture coordinate of this grass vertex.
	Vector2 _TextureCoordinate;

	//The modulator factor of this grass vertex.
	float _ModulatorFactor;

	/*
	*	Default constructor - prohibited, must be constructed with the proper arguments.
	*/
	GrassVertex() NOEXCEPT = delete;

	/*
	*	Constructor taking all values as arguments.
	*/
	GrassVertex(	const Vector3 &initialPosition,
	...
	*/
	GrassVertex(	const float initialPositionX,
