...
class AudioAssetCompiler final : public AssetCompiler
{
...
public:
	...
	*/
	...
	{
		return new (_AssetAllocator.Allocate()) AudioAsset();
	}
	...
	*/
	...
	{
		statistics->_AssetTypeName = "Audio";
...
private:
	...
	//The asset allocator.
	PoolAllocator<sizeof(AudioAsset)> _AssetAllocator;
