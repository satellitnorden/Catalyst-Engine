...
nam::parametric_wavenet::_DilatedConv::_DilatedConv(const int in_channels, const int out_channels, const int kernel_size,
...
void nam::parametric_wavenet::_Layer::process_(const Eigen::MatrixXf& input, const Eigen::MatrixXf& condition,
...
void nam::parametric_wavenet::_Layer::set_num_frames_(const long num_frames)
{
...
nam::parametric_wavenet::_LayerArray::_LayerArray(const int input_size, const int condition_size, const int head_size,
...
void nam::parametric_wavenet::_LayerArray::advance_buffers_(const int num_frames)
{
...
void nam::parametric_wavenet::_LayerArray::prepare_for_frames_(const long num_frames)
{
  // Example:
  // _buffer_start = 0
  // num_frames = 64
...
void nam::parametric_wavenet::_LayerArray::process_(const Eigen::MatrixXf& layer_inputs, const Eigen::MatrixXf& condition,
...
void nam::parametric_wavenet::_LayerArray::set_num_frames_(const long num_frames)
{
...
long nam::parametric_wavenet::_LayerArray::_get_receptive_field() const
{
...
void nam::parametric_wavenet::_LayerArray::_rewind_buffers_()
...
nam::parametric_wavenet::_Head::_Head(const int input_size, const int num_layers, const int channels, const std::string activation)
: _channels(channels)
...
void nam::parametric_wavenet::_Head::Reset(const double sampleRate, const int maxBufferSize)
{
  set_num_frames_((long)maxBufferSize);
}

void nam::parametric_wavenet::_Head::set_weights_(std::vector<float>::iterator& weights)
{
  for (size_t i = 0; i < this->_layers.size(); i++)
    this->_layers[i].set_weights_(weights);
}

void nam::parametric_wavenet::_Head::process_(Eigen::MatrixXf& inputs, Eigen::MatrixXf& outputs)
{
...
void nam::parametric_wavenet::_Head::set_num_frames_(const long num_frames)
{
...
void nam::parametric_wavenet::_Head::_apply_activation_(Eigen::MatrixXf& x)
{
...
nam::parametric_wavenet::ParametricWaveNet::ParametricWaveNet(const std::vector<nam::parametric_wavenet::LayerArrayParams>& layer_array_params,
...
void nam::parametric_wavenet::ParametricWaveNet::_advance_buffers_(const int num_frames)
{
  for (size_t i = 0; i < this->_layer_arrays.size(); i++)
    this->_layer_arrays[i].advance_buffers_(num_frames);
}

void nam::parametric_wavenet::ParametricWaveNet::_prepare_for_frames_(const long num_frames)
{
  for (size_t i = 0; i < this->_layer_arrays.size(); i++)
...
void nam::parametric_wavenet::ParametricWaveNet::_set_condition_array(NAM_SAMPLE* input, const int num_frames)
{
    ...
    {
        for (int condition_index = 0; condition_index < _condition_size; ++condition_index)
        {
            this->_condition(condition_index, frame_index) = input[counter++];
        }
    }
}
                                                ...
                                                const double expectedSampleRate)
{
  ...
  return std::make_unique<nam::parametric_wavenet::ParametricWaveNet>(
