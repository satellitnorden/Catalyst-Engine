...
namespace nam
{
    namespace parametric_wavenet
    {
        ...
        /// \brief The main parametric WaveNet model
        ///
        ...
        public:
            ...
            ParametricWaveNet(const int in_channels, const std::vector<wavenet::LayerArrayParams>& layer_array_params, const float head_scale,
                const bool with_head, std::optional<wavenet::HeadParams> head_params, std::vector<float> weights,
        ...
        private:
            ...
            std::vector<wavenet::detail::LayerArray> _layer_arrays;

            float _head_scale;

            std::unique_ptr<wavenet::detail::Head> _post_stack_head;
        ...
        struct WaveNetConfig : public ModelConfig
        {
            ...
            float head_scale;
            bool with_head;
            std::optional<wavenet::HeadParams> head_params;
