...
void ScreenSpaceIndirectLightingGraphicsPipeline::Initialize(const RenderingConfiguration::IndirectLightingQuality quality) NOEXCEPT
{
	...
	SetFragmentShader(ResourceSystem::Instance->GetShaderResource(HashString("ScreenSpaceIndirectLightingFragmentShader"))->_Handle);
...
*/
void ScreenSpaceIndirectLightingGraphicsPipeline::Execute() NOEXCEPT
{
...
void ScreenSpaceIndirectLightingGraphicsPipeline::CreateRenderDataTable(const RenderingConfiguration::IndirectLightingQuality quality) NOEXCEPT
{
	...
	switch (quality)
	{
		case RenderingConfiguration::IndirectLightingQuality::LOW:
		{
			RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(1, 0, &_RenderDataTable, RenderingSystem::Instance->GetSharedRenderTargetManager()->GetSharedRenderTarget(SharedRenderTarget::SCENE_FEATURES_2_HALF), RenderingSystem::Instance->GetSampler(Sampler::FilterNearest_MipmapModeNearest_AddressModeClampToEdge));
			RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(2, 0, &_RenderDataTable, RenderingSystem::Instance->GetSharedRenderTargetManager()->GetSharedRenderTarget(SharedRenderTarget::SCENE_FEATURES_3_HALF), RenderingSystem::Instance->GetSampler(Sampler::FilterNearest_MipmapModeNearest_AddressModeClampToEdge));
