...
*	Default constructor.
*/
SecondTemporalAccumulationGraphicsPipeline::SecondTemporalAccumulationGraphicsPipeline() NOEXCEPT
{
	//Set the initialization function.
	SetInitializationFunction([]()
	{
		SecondTemporalAccumulationGraphicsPipeline::Instance->InitializeInternal();
	});

	//Set the execution function.
	SetExecutionFunction([]()
	{
		SecondTemporalAccumulationGraphicsPipeline::Instance->RenderInternal();
	});
}

/*
*	Initializes the second temporal accumulation pipeline.
*/
void SecondTemporalAccumulationGraphicsPipeline::InitializeInternal() NOEXCEPT
{
	...
	//Set the main stage.
	SetMainStage(RenderPassStage::SecondTemporalAccumulation);
	...
	AddRenderTarget(RenderTarget::TemporalAccumulationBuffer1);
...
*/
void SecondTemporalAccumulationGraphicsPipeline::CreateRenderDataTableLayout() NOEXCEPT
{
...
*/
void SecondTemporalAccumulationGraphicsPipeline::CreateRenderDataTable() NOEXCEPT
{
	RenderingSystem::Instance->CreateRenderDataTable(_RenderDataTableLayout, &_RenderDataTable);

	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(0, 0, &_RenderDataTable, RenderingSystem::Instance->GetRenderTarget(RenderTarget::TemporalAccumulationBuffer2), RenderingSystem::Instance->GetSampler(Sampler::FilterNearest_MipmapModeNearest_AddressModeClampToEdge));
