...
void ScreenSpaceAmbientOcclusionGraphicsPipeline::Initialize(const RenderTargetHandle ambient_occlusion_render_target) NOEXCEPT
{
	...
	SetFragmentShader(ResourceSystem::Instance->GetShaderResource(HashString("ScreenSpaceAmbientOcclusionFragmentShader"))->_Handle);
	...
	//Set the name.
	SetName("Screen Space Ambient Occlusion");
#endif
}
