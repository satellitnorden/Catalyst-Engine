...
*/
void AmbientOcclusionApplicationGraphicsPipeline::Initialize(const RenderTargetHandle ambient_occlusion_render_target) NOEXCEPT
{
	...
	SetFragmentShader(ResourceSystem::Instance->GetShaderResource(HashString("AmbientOcclusionApplicationFragmentShader"))->_Handle);
...
*/
void AmbientOcclusionApplicationGraphicsPipeline::Execute() NOEXCEPT
{
...
*/
void AmbientOcclusionApplicationGraphicsPipeline::CreateRenderDataTableLayout() NOEXCEPT
{
...
*/
void AmbientOcclusionApplicationGraphicsPipeline::CreateRenderDataTable(const RenderTargetHandle ambient_occlusion_render_target) NOEXCEPT
{
	...
	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(1, 0, &_RenderDataTable, PostSceneFeaturesRenderPass::Instance->GetDepthMip(0), RenderingSystem::Instance->GetSampler(Sampler::FilterNearest_MipmapModeNearest_AddressModeClampToEdge));
	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(2, 0, &_RenderDataTable, ambient_occlusion_render_target, RenderingSystem::Instance->GetSampler(Sampler::FilterNearest_MipmapModeNearest_AddressModeClampToEdge));
	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(3, 0, &_RenderDataTable, RenderingSystem::Instance->GetSharedRenderTargetManager()->GetSharedRenderTarget(SharedRenderTarget::SCENE_FEATURES_3), RenderingSystem::Instance->GetSampler(Sampler::FilterNearest_MipmapModeNearest_AddressModeClampToEdge));
}