...
void PostProcessingGraphicsPipeline::Initialize() NOEXCEPT
{
	...
	SetFragmentShader(ResourceSystem::Instance->GetShaderResource(HashString("PostProcessingFragmentShader")));
...
void PostProcessingGraphicsPipeline::CreateRenderDataTable() NOEXCEPT
{
	...
	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(0, 0, &_RenderDataTable, RenderingSystem::Instance->GetRenderTarget(RenderTarget::INTERMEDIATE_RGBA_FLOAT32_1), RenderingSystem::Instance->GetSampler(Sampler::FilterLinear_MipmapModeNearest_AddressModeClampToEdge));
}