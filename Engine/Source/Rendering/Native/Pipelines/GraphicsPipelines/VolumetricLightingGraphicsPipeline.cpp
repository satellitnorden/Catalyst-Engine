...
void VolumetricLightingGraphicsPipeline::Initialize() NOEXCEPT
{
	...
	SetFragmentShader(Shader::VolumetricLightingFragment);
...
void VolumetricLightingGraphicsPipeline::CreateRenderDataTable() NOEXCEPT
{
	...
	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(0, 0, &_RenderDataTable, RenderingSystem::Instance->GetRenderTarget(RenderTarget::SCENE_FEATURES_2_HALF), RenderingSystem::Instance->GetSampler(Sampler::FilterLinear_MipmapModeNearest_AddressModeClampToEdge));
}