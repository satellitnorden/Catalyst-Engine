...
*/
void VisibilityDenoisingGraphicsPipeline::Initialize(const Direction direction, const float stride, const RenderTargetHandle source, const RenderTargetHandle target) NOEXCEPT
{
...
*/
void VisibilityDenoisingGraphicsPipeline::CreateRenderDataTableLayout() NOEXCEPT
{
...
*/
void VisibilityDenoisingGraphicsPipeline::CreateRenderDataTable(const RenderTargetHandle source) NOEXCEPT
{
...
*/
void VisibilityDenoisingGraphicsPipeline::Execute() NOEXCEPT
{
