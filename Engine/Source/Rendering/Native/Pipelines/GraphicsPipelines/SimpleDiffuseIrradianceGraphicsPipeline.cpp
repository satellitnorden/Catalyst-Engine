...
*/
void SimpleDiffuseIrradianceGraphicsPipeline::Initialize() NOEXCEPT
{
	//Set the shaders.
	...
	SetFragmentShader(Shader::SimpleDiffuseIrradianceFragment);
...
*/
void SimpleDiffuseIrradianceGraphicsPipeline::Execute() NOEXCEPT
{
