...
DEFINE_SINGLETON(LowDetailDebrisVegetationRenderPass);
...
*	Default constructor.
*/
LowDetailDebrisVegetationRenderPass::LowDetailDebrisVegetationRenderPass() NOEXCEPT
{
	//Set the initialization function.
	SetInitializationFunction([](void *const RESTRICT)
	{
		LowDetailDebrisVegetationRenderPass::Instance->InitializeInternal();
	});
}
...
*/
void LowDetailDebrisVegetationRenderPass::InitializeInternal() NOEXCEPT
{
	//Set the main stage.
	SetMainStage(RenderPassMainStage::Scene);

	//Set the sub stage.
	SetSubStage(RenderPassSubStage::LowDetailDebrisVegetation);

	//Set the shaders.
	SetVertexShader(Shader::LowDetailDebrisVegetationVertex);
	SetTessellationControlShader(Shader::None);
	SetTessellationEvaluationShader(Shader::None);
	SetGeometryShader(Shader::None);
	SetFragmentShader(Shader::LowDetailDebrisVegetationFragment);
	...
	{
		LowDetailDebrisVegetationRenderPass::Instance->RenderInternal();
	});
...
/*
*	Renders the low detail vegetation.
*/
void LowDetailDebrisVegetationRenderPass::RenderInternal() NOEXCEPT
{
	...
	for (const DebrisVegetationTypeInformation &information : *informations)
	{
		...
		for (const DebrisVegetationPatchRenderInformation &renderInformation : information._PatchRenderInformations)
		{
			...
			//Draw the instances!
			commandBuffer->DrawIndexed(this, information._Model._IndexCounts[UNDERLYING(LevelOfDetail::Low)], renderInformation._NumberOfTransformations[UNDERLYING(LevelOfDetail::High)]);
		}
	}
