...
DEFINE_SINGLETON(MediumDetailDebrisVegetationRenderPass);
...
*	Default constructor.
*/
MediumDetailDebrisVegetationRenderPass::MediumDetailDebrisVegetationRenderPass() NOEXCEPT
{
	//Set the initialization function.
	SetInitializationFunction([](void *const RESTRICT)
	{
		MediumDetailDebrisVegetationRenderPass::Instance->InitializeInternal();
	});
}
...
*/
void MediumDetailDebrisVegetationRenderPass::InitializeInternal() NOEXCEPT
{
	//Set the main stage.
	SetMainStage(RenderPassMainStage::Scene);

	//Set the sub stage.
	SetSubStage(RenderPassSubStage::MediumDetailDebrisVegetation);

	//Set the shaders.
	SetVertexShader(Shader::MediumDetailDebrisVegetationVertex);
	SetTessellationControlShader(Shader::None);
	SetTessellationEvaluationShader(Shader::None);
	SetGeometryShader(Shader::None);
	SetFragmentShader(Shader::MediumDetailDebrisVegetationFragment);
	...
	{
		MediumDetailDebrisVegetationRenderPass::Instance->RenderInternal();
	});
...
/*
*	Renders the medium detail vegetation.
*/
void MediumDetailDebrisVegetationRenderPass::RenderInternal() NOEXCEPT
{
	...
	for (const DebrisVegetationTypeInformation &information : *informations)
	{
		...
		for (const DebrisVegetationPatchRenderInformation &renderInformation : information._PatchRenderInformations)
		{
			...
			//Draw the instances!
			commandBuffer->DrawIndexed(this, information._Model._IndexCounts[UNDERLYING(LevelOfDetail::Medium)], renderInformation._NumberOfTransformations[UNDERLYING(LevelOfDetail::High)]);
		}
	}
