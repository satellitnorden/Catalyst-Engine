...
*	Default constructor.
*/
DepthOfFieldHorizontalRenderPass::DepthOfFieldHorizontalRenderPass() NOEXCEPT
{
	//Set the initialization function.
	SetInitializationFunction([](void *const RESTRICT)
	{
		DepthOfFieldHorizontalRenderPass::Instance->InitializeInternal();
	});
}
...
*/
void DepthOfFieldHorizontalRenderPass::InitializeInternal() NOEXCEPT
{
	...
	//Set the main stage.
	SetMainStage(RenderPassMainStage::DepthOfFieldHorizontal);

	//Set the sub stage.
	SetSubStage(RenderPassSubStage::DepthOfFieldHorizontal);
	...
	{
		DepthOfFieldHorizontalRenderPass::Instance->RenderInternal();
	});
...
*/
void DepthOfFieldHorizontalRenderPass::CreateRenderDataTable() NOEXCEPT
{
	RenderingSystem::Instance->CreateRenderDataTable(_RenderDataTableLayout, &_RenderDataTable);

	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(0, 0, _RenderDataTable, RenderingSystem::Instance->GetRenderTarget(RenderTarget::Scene), RenderingSystem::Instance->GetSampler(SamplerProperties(TextureFilter::Nearest, MipmapMode::Nearest, AddressMode::ClampToEdge)));
...
*/
void DepthOfFieldHorizontalRenderPass::RenderInternal() NOEXCEPT
{
