...
void BloomUpsampleFirstIterationRenderPass::CreateRenderDataTable() NOEXCEPT
{
	...
	RenderingSystem::Instance->BindCombinedImageSamplerToRenderDataTable(0, 0, _RenderDataTable, RenderingSystem::Instance->GetRenderTarget(RenderTarget::IntermediateThirtySecond), RenderingSystem::Instance->GetSampler(Sampler::FilterLinear_MipmapModeNearest_AddressModeClampToEdge));
}
...
void BloomUpsampleFirstIterationRenderPass::RenderInternal() NOEXCEPT
{
	...
	data._TexelSize._X = 1.0f / static_cast<float>(RenderingSystem::Instance->GetScaledResolution()._Width / 32);
	data._TexelSize._Y = 1.0f / static_cast<float>(RenderingSystem::Instance->GetScaledResolution()._Height / 32);
