...
DEFINE_SINGLETON(LowDetailGrassVegetationDepthRenderPass);
...
*	Default constructor.
*/
LowDetailGrassVegetationDepthRenderPass::LowDetailGrassVegetationDepthRenderPass() NOEXCEPT
{
	//Set the initialization function.
	SetInitializationFunction([](void *const RESTRICT)
	{
		LowDetailGrassVegetationDepthRenderPass::Instance->InitializeInternal();
	});
}
...
*/
void LowDetailGrassVegetationDepthRenderPass::InitializeInternal() NOEXCEPT
{
	//Set the main stage.
	SetMainStage(RenderPassMainStage::Scene);

	//Set the sub stage.
	SetSubStage(RenderPassSubStage::LowDetailGrassVegetationDepth);

	//Set the shaders.
	SetVertexShader(Shader::LowDetailGrassVegetationDepthVertex);
	SetTessellationControlShader(Shader::None);
	SetTessellationEvaluationShader(Shader::None);
	SetGeometryShader(Shader::None);
	SetFragmentShader(Shader::LowDetailGrassVegetationDepthFragment);
	...
	{
		LowDetailGrassVegetationDepthRenderPass::Instance->RenderInternal();
	});
...
*/
void LowDetailGrassVegetationDepthRenderPass::RenderInternal() NOEXCEPT
{
