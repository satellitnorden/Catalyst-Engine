...
DEFINE_SINGLETON(BloomUpsampleFifthIterationRenderPass);
...
*	Default constructor.
*/
BloomUpsampleFifthIterationRenderPass::BloomUpsampleFifthIterationRenderPass() NOEXCEPT
{
	//Set the initialization function.
	SetInitializationFunction([](void *const RESTRICT)
	{
		BloomUpsampleFifthIterationRenderPass::Instance->InitializeInternal();
	});
}
...
*/
void BloomUpsampleFifthIterationRenderPass::InitializeInternal() NOEXCEPT
{
	...
	//Set the main stage.
	SetMainStage(RenderPassMainStage::BloomUpsampleFifthIteration);

	//Set the sub stage.
	SetSubStage(RenderPassSubStage::BloomUpsampleFifthIteration);
	...
	{
		BloomUpsampleFifthIterationRenderPass::Instance->RenderInternal();
	});
...
*/
void BloomUpsampleFifthIterationRenderPass::CreateRenderDataTableLayout() NOEXCEPT
{
...
*/
void BloomUpsampleFifthIterationRenderPass::CreateRenderDataTable() NOEXCEPT
{
...
*/
void BloomUpsampleFifthIterationRenderPass::RenderInternal() NOEXCEPT
{
