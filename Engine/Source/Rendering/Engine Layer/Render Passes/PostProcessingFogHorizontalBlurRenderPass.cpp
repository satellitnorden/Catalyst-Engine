//Header file.
#include <Rendering/Engine Layer/Render Passes/PostProcessingFogHorizontalBlurRenderPass.h>
...
DEFINE_SINGLETON(PostProcessingFogHorizontalBlurRenderPass);

/*
*	Default constructor.
*/
PostProcessingFogHorizontalBlurRenderPass::PostProcessingFogHorizontalBlurRenderPass() NOEXCEPT
{
	//Set the initialization function.
	SetInitializationFunction([](void *const RESTRICT)
	{
		PostProcessingFogHorizontalBlurRenderPass::Instance->InitializeInternal();
	});
}

/*
*	Initializes the post processing fog horizontal blur render pass.
*/
void PostProcessingFogHorizontalBlurRenderPass::InitializeInternal() NOEXCEPT
{
	//Set the stage.
	SetStage(RenderPassStage::PostProcessingFogHorizontalBlur);
	...
	AddRenderTarget(RenderTarget::FogBlurIntermediate);
	...
	{
		PostProcessingFogHorizontalBlurRenderPass::Instance->RenderInternal();
	});
...
*/
void PostProcessingFogHorizontalBlurRenderPass::RenderInternal() NOEXCEPT
{
	...
	StaticArray<RenderDataTableHandle, 2> descriptorSets
	{
		...
		RenderingSystem::Instance->GetRenderDataTable(RenderDataTable::PostProcessingFogHorizontalBlur)
	};
