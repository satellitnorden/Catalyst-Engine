...
void RenderingSystem::InitializeRenderTargets() NOEXCEPT
{
	...
	CreateRenderTarget(GetScaledResolution(), TextureFormat::R32G32B32A32_Float, &_RenderTargets[UNDERLYING(RenderTarget::DiffuseIrradianceTemporalAccumulationBuffer1)]);
	CreateRenderTarget(GetScaledResolution(), TextureFormat::R32G32B32A32_Float, &_RenderTargets[UNDERLYING(RenderTarget::DiffuseIrradianceTemporalAccumulationBuffer2)]);
