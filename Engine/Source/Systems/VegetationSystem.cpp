...
void VegetationSystem::UpdateGrassVegetationAsynchronous() NOEXCEPT
{
	...
	for (GrassVegetationTypeInformation &information : _GrassVegetationTypeInformations)
	{
		...
		const GridPoint2 currentGridPoint{ GridPoint2::WorldPositionToGridPoint(viewerPosition, information._Properties._CutoffDistance * VegetationConstants::GRASS_VEGETATION_GRID_SIZE) };
...
void VegetationSystem::UpdateSolidVegetationAsynchronous() NOEXCEPT
{
	...
	{
		//Calculate the current grid point based on the current viewer position.
		const GridPoint2 currentGridPoint{ GridPoint2::WorldPositionToGridPoint(viewerPosition, information._Properties._CutoffDistance * VegetationConstants::SOLID_VEGETATION_GRID_SIZE) };
