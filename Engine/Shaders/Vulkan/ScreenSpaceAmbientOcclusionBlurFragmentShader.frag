...
float Blur()
{
    ...
    return  currentOcclusion * 0.2f
            + Sample(currentOcclusion, currentDepth, fragmentTextureCoordinate - offset1) * 0.2f
            + Sample(currentOcclusion, currentDepth, fragmentTextureCoordinate + offset1) * 0.2f
            + Sample(currentOcclusion, currentDepth, fragmentTextureCoordinate - offset2) * 0.2f
            + Sample(currentOcclusion, currentDepth, fragmentTextureCoordinate + offset2) * 0.2f;
}
