...
void main()
{
	...
	vec3 irradiance = mix(SkyColor(reflect(current_features.view_direction, current_features.normal), true), SkyColor(current_features.normal, false), current_features.roughness * (1.0f - current_features.metallic));
