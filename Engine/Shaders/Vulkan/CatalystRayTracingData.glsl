...
layout (set = 1, binding = 6) buffer DYNAMIC_MODEL_VERTEX_DATA_BUFFER { vec4 DYNAMIC_MODEL_VERTEX_DATA[]; } DYNAMIC_MODEL_VERTEX_BUFFERS[MAXIMUM_NUMBER_OF_RAY_TRACED_DYNAMIC_MODELS];
layout (set = 1, binding = 7) buffer DYNAMIC_MODEL_INDEX_DATA_BUFFER { uint DYNAMIC_MODEL_INDEX_DATA[]; } DYNAMIC_MODEL_INDEX_BUFFERS[MAXIMUM_NUMBER_OF_RAY_TRACED_DYNAMIC_MODELS];
