...
glslangValidator.exe -V AttachDetailFragmentShader.frag -o 				AttachDetailFragmentShader.spv
...
glslangValidator.exe -V DetachDetailFragmentShader.frag -o 				DetachDetailFragmentShader.spv
