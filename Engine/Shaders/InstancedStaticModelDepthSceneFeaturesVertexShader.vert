...
void CatalystShaderMain()
{
	...
	{
		fragment_fade_out_opacity = 1.0f - (clamp(LengthSquared3(world_position - PERCEIVER_WORLD_POSITION) - START_FADE_OUT_DISTANCE_SQUARED, 0.0f, END_FADE_OUT_DISTANCE_SQUARED - START_FADE_OUT_DISTANCE_SQUARED) / (END_FADE_OUT_DISTANCE_SQUARED - START_FADE_OUT_DISTANCE_SQUARED));
	}
