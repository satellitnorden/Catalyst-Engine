...
glslangValidator.exe -V EnvironmentMaterialFragmentShader.frag -o 		EnvironmentMaterialFragmentShader.spv
glslangValidator.exe -V EnvironmentMaterialVertexShader.vert -o 		EnvironmentMaterialVertexShader.spv
