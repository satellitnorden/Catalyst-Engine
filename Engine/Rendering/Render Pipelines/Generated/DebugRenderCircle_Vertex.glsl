...
{
	layout (offset = 0) vec4 POSITION_RADIUS;
...
void main()
{
    ...
    (
        POSITION_RADIUS.x + mix(-1.0f, 1.0f, float(gl_VertexIndex / 2)) * POSITION_RADIUS.w,
        POSITION_RADIUS.y,
        POSITION_RADIUS.z + mix(-1.0f, 1.0f, float(gl_VertexIndex & 1)) * POSITION_RADIUS.w
    );
